...
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:0.44] {8.88877 + 53.2782*x};
...
\addlegendentry{Untergrund}
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:0.44] {28.6315 - 18.414*x};
\addlegendentry{Fitgerade}
\end{axis}
...
\addlegendentry{Untergrund}
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:0.44] {26.2496 - 13.8354*x};
\addlegendentry{Fitgerade}
\end{axis}
...
\addlegendentry{Untergrund}
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:0.44] {-4.30741 + 85.2084*x};
\addlegendentry{Fitgerade}
\end{axis}

\end{tikzpicture}
\captionof{figure}{Streudaten der nicht von uns selbst hergestellten Proben. Zu erkennen ist ein von der Kristallisationstemperatur der Probe abhängender Peak und ein anschließender, annähernd linear Anstieg der gemessenen Intensität.}
\end{figure}
...
\begin{center}
  \begin{tabular}{|p{7cm}|p{4.5cm}|p{4.5cm}|}
    \hline
    Kristallisierungstemperatur der Probe & a                      & b                      \\ \hline
    140                                   & $53,2782 \pm 41,6721$  & $8,88877 \pm 13,4815$  \\ \hline
    170                                   & $-18,414 \pm 42,6279$  & $28,6315 \pm 13,6246$  \\ \hline
    170 (selbst getempert)                & $-22,5995 \pm 41,975$  & $22,1899 \pm 12,9489$  \\ \hline
    200                                   & $-13,8354 \pm 35,6281$ & $26,2496 \pm 10,7408$  \\ \hline
    215                                   & $85,2084 \pm 33,7823$  & $-4,30741 \pm 10,1843$ \\ \hline
	\end{tabular}
\end{center}

Auf grund der sehr hohen Streuung der hinteren Messwerte sind die resultierenden fits wie erwartet mit einem sehr großen Fehler behaftet.
...
Dazu wird durch den anfänglich linear abfallenden Teil eine Fitgerade gelegt. Der y-Achsenabschnitt dieser Gerade gibt uns den Wert für Q, welcher sich in den gesuchten Wert $\Phi_c$ für die Kristallinität der Probe umrechnen lässt. Den Wert für $d_c$ ist der x-Wert des Schnittpunktes der fitgeraden mit einer Konstanten, die durch den tiefsten Punkt der Autokorrelationsfunktion verläuft. Den Wert für $d_{ac}$ erhält man aus dem x-Wert des ersten lokalen Maximums der Autokorrelationsfunktion.
...
\addplot[blue, mark=x, mark size=0pt, samples=20] {141.435 - 62.1333*x};
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:25] {-69.9944};
\draw (axis cs:3.4028309859764407,-69.9944) -- (axis cs:3.4028309859764407,0) node [above] {$d_c$};
\draw (axis cs:9.62545,0) -- (axis cs:9.62545,18.1889) node [above] {$d_{ac}$};
\addlegendentry{Fitgerade}
\end{axis}
...
\addplot[black, mark=x, mark size=0pt, samples=20, domain=0:25] {0};
\addplot[blue, mark=x, mark size=0pt, samples=20] {151.827 - 62.233*x};
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:25] {-94.0629};
\draw (axis cs:3.9511177627482557,-94.0629) -- (axis cs:3.9511177627482557,0) node [above] {$d_c$};
\draw (axis cs:10.8286,0) -- (axis cs:10.8286,24.2523) node [above] {$d_{ac}$};
\addlegendentry{Fitgerade}
\end{axis}
...
\addplot[black, mark=x, mark size=0pt, samples=20, domain=0:25] {0};
\addplot[blue, mark=x, mark size=0pt, samples=20] {146.043 - 50.1273*x};
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:25] {-82.6048};
\draw (axis cs:4.561345164316567,-82.6048) -- (axis cs:4.561345164316567,0) node [above] {$d_c$};
\draw (axis cs:12.6334,0) -- (axis cs:12.6334,21.1631) node [above] {$d_{ac}$};
\addlegendentry{Fitgerade}
\end{axis}
...
\addplot[black, mark=x, mark size=0pt, samples=20, domain=0:25] {0};
\addplot[blue, mark=x, mark size=0pt, samples=20] {163.311 - 55.806*x};
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:25] {-85.3636};
\draw (axis cs:4.45604668027861,-85.3636) -- (axis cs:4.45604668027861,0) node [above] {$d_c$};
\draw (axis cs:12.6334,0) -- (axis cs:12.6334,19.6929) node [above] {$d_{ac}$};
\addlegendentry{Fitgerade}
\end{axis}
...
\addplot[black, mark=x, mark size=0pt, samples=20, domain=0:25] {0};
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:6] {134.23 - 36.6323*x};
\addplot[blue, mark=x, mark size=0pt, samples=20, domain=0:25] {-43.9908};
\draw (axis cs:4.865133613018904,-43.9908) -- (axis cs:4.865133613018904,0) node [above] {$d_c$};
\draw (axis cs:15.0398,0) -- (axis cs:15.0398,6.91414) node [above] {$d_{ac}$};
\addlegendentry{Fitgerade}
\end{axis}
...
\begin{center}
  \begin{tabular}{|p{4.5cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|}
    \hline
    Kristallisierungstemperatur der Probe in °C & $d_c$ in $nm$     & $d_{ac}$ in $nm$   & Q                 & $ \Phi_c$         \\ \hline
    140                                         & $3,402 \pm 0,047$ & $ 9,625 \pm 0,481$ & $141,44 \pm 4,25$ & $0,113 \pm 0,004$ \\ \hline
    170                                         & $3,951 \pm 0,045$ & $10,829 \pm 0,541$ & $151,83 \pm 4,16$ & $0,123 \pm 0,004$ \\ \hline
    170 (selbst getempert)                      & $4,561 \pm 0,066$ & $12,633 \pm 0,632$ & $146,04 \pm 4,95$ & $0,117 \pm 0,005$ \\ \hline
    200                                         & $4,456 \pm 0,057$ & $12,633 \pm 0,632$ & $163,31 \pm 5,00$ & $0,134 \pm 0,005$ \\ \hline
    215                                         & $4,865 \pm 0,073$ & $15,040 \pm 0,752$ & $134,23 \pm 3,40$ & $0,106 \pm 0,003$ \\ \hline
	\end{tabular}
\end{center}
...
\addplot[red, only marks, mark=x, mark size=2pt, 
  ...
  coordinates{
  (62.85,4.561) +- (0.5, 0.066)
};
\addlegendentry{Selbst erstellte Probe}
\addplot[blue, only marks, mark=x, mark size=2pt, 
  error bars/.cd, y dir=both,y explicit, x dir=both,x explicit]
  coordinates{
  (17.85,4.865) +- (0.5, 0.073)
  (32.85,4.456) +- (0.5, 0.057)
  (62.85,3.951) +- (0.5, 0.045)
  (92.85,3.402) +- (0.5, 0.047)
};
\addlegendentry{Gestellte Proben}

\addplot[black, mark=x, mark size=0pt, samples=20, domain=0:20] {3.34196 + 29.2207/x};
\addplot[black, mark=x, mark size=0pt, samples=40, domain=20:100] {3.34196 + 29.2207/x};
...
\addplot[red, only marks, mark=x, mark size=2pt, 
  error bars/.cd, y dir=both,y explicit, x dir=both,x explicit]
  coordinates{
  (62.85,12.633) +- (0.5, 0.632)
};
\addlegendentry{Selbst erstellte Probe}
\addplot[blue, only marks, mark=x, mark size=2pt, 
  error bars/.cd, y dir=both,y explicit, x dir=both,x explicit]
  coordinates{
  (92.85, 9.625) +- (0.5, 0.481)
  (62.85,10.829) +- (0.5, 0.541)
  (32.85,12.633) +- (0.5, 0.632)
  (17.85,15.040) +- (0.5, 0.752)
};
\addlegendentry{Gestellte Proben}

\addplot[black, mark=x, mark size=0pt, samples=20, domain=0:20] {5.62831 + 39.9539/x^0.5};
\addplot[black, mark=x, mark size=0pt, samples=40, domain=20:100] {5.62831 + 39.9539/x^0.5};
\addlegendentry{Fit-Kurve}
\end{axis}
\end{tikzpicture}
\captionof{figure}{}
...
Zur Auswertung des Kristallationsgrades der Proben in Abhängigkeit zur Kristallisationstemperatur haben wir einen parabelförmigen Fit durch die uns zur Verfügung stehenden Messdaten gelegt. 
...
\begin{axis}[
  ...
  x tick label style={/pgf/number format/1000 sep=},
  xlabel=Kristallisationstemperatur in °C
  y tick label style={/pgf/number format/1000 sep=},
  width=0.9\linewidth,
...
\addplot[black, mark=x, mark size=0pt, samples=60, domain=100:230] {-0.305912 + 0.00491231*x - 0.0000138191*x^2};
\addlegendentry{Fit-Kurve}
\end{axis}
\end{tikzpicture}
\captionof{figure}{}
